                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          ...
                          style: const TextStyle(color: Color(0xFF5538C9), fontSize: 12, fontWeight: FontWeight.bold),
                        ),
                      ),
                      const Spacer(),
                      const Icon(Icons.star_rounded, color: Colors.amber, size: 20),
                      const SizedBox(width: 4),
                      Text(widget.product.rating.toString(), style: const TextStyle(fontWeight: FontWeight.bold)),
                      Text(" (120 reviews)", style: TextStyle(color: Colors.grey.shade500, fontSize: 13)),
                    ],
                  ),
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            ...
                            style: const TextStyle(fontSize: 32, fontWeight: FontWeight.w900, color: Color(0xFF5538C9)),
                          ),
                          Text(
                        ...
                        child: Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                "$_quantity",
                                style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: Color(0xFF5538C9)),
                              ),
                            ),
  ...
  Widget _buildQuantityIcon(IconData icon, VoidCallback onTap) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Icon(icon, color: const Color(0xFF5538C9), size: 20),
      ),
    );
  }
